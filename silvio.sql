...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-05-2020 a las 06:20:36
...
CREATE TABLE `customer` (
  ...
  `CustomerCardName` varchar(50) NOT NULL,
  `CustomerCardNo` int(11) NOT NULL,
  `CustomerCardExpire` int(11) NOT NULL,
